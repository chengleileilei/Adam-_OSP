# <a href="https://gitee.com/lyt-top/vue-next-admin/tree/suwen_sang" target="_blank">suwen_sang 更新日志</a>

🎉🎉🔥 `suwen_sang` 基于 vue2.x + webpack + element ui，适配手机、平板、pc 的后台开源免费模板库（vue3.x 请切换 master 分支）
