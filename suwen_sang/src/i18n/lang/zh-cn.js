...
export default {
    router: {
        ...
        application: '可信赖测试调试平台',
        attack_robust: '对抗攻击鲁棒性测试',
        attack_item_1: '样本数字攻击',
        attack_item_2: '样本物理攻击',
        attack_item_3: '模型对抗鲁棒性',
        change_robust: '图像变换鲁棒性测试',
        fairness_test: '多模态预训练公平性测试',
        menu: '可信赖测试调试平台',
        menu1: '对抗攻击鲁棒性测试',
        menu11: '样本数字攻击',
        menu12: '样本物理攻击',
