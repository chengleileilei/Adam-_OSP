 ...
 * @LastEditTime: 2022-06-07 01:46:24
		...
		<div class="content">
			<el-card class="box-card">
				...
				<div class="content-top-test">
					...
					<div class="pic_right">
						<el-image :src="testSrcResult" style="width: 250px; height: 250px; margin-left: 10px"></el-image>
						<div class="test_pic_btn">
			...
			<el-card class="box-card">
				...
				<div class="content-top">
					...
					<div class="pic_right">
						<div v-if="src">
							<el-image :src="src" style="width: 250px; height: 250px; margin-left: 10px"></el-image>
						</div>
						<!-- <div class="demo-image__error" v-else>
							<div class="block">
								<el-image style="width: 250px; height: 250px; margin-left: 10px">
...
<script>
import { generateImage } from '@/api/face';
export default {
	name: 'menu11',
	data() {
		return {
	...
	methods: {
		...
		settingSubmit() {
			...
			let param = this.form;
			generateImage(param).then(async (res) => {
